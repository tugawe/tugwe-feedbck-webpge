...
const SignInPage: React.FC = () => {
  ...
  return (
    <div style={{ minHeight: "75vh", display: "flex", background: "#fff" }}>
      {/* Left: Image */}
      ...
      {/* Right: Content */}
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 60px", width: '30vw' }}>
        {/* Tabs */}
